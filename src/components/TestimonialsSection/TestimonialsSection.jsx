...
const testimonials = [
  ...
  },
  {
    ...
    testimonial:
      "armincx integrates with our entire tech stack and even automates Asana tickets for our logistics. I'm very impressed with the tool."
  },
  {
    name: "Anes Hodzic",
    company: "kazaarfragrances",
    testimonial:
      "An AI chatbot for all channels, the best WhatsApp marketing tool, integrated with klaviyo, Shopify, billbee and 8returns. At fair conditions. We are happy."
  },
  {
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-lg text-[#6e7687] max-w-2xl mx-auto">
            What leading E-Com brands from the DACH region say about armincx
          </p>
        </div>
