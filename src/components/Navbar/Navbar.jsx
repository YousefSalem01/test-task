...
export function Navbar() {
	...
	return (
		<>
			{/* Gradient background */}
			<div className='fixed top-0 left-0 right-0 h-32 bg-gradient-to-r from-blue-100 via-purple-50 to-green-100 opacity-60 z-40 pointer-events-none' />
					...
					{isMenuOpen && (
						...
						>
							...
							<div className='flex flex-col space-y-4'>
								...
								<Link to='/signin' className='text-[#6e7687] hover:text-[#4361EE] text-sm font-medium text-center py-2 transition-colors'>
									Sign In
								</Link>
							</div>
						</motion.div>
