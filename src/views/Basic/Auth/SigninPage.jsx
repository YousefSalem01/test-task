	...
	return (
		<div className='min-h-screen flex flex-col md:flex-row'>
			...
			<div className='w-full md:w-1/2 bg-gray-900 relative overflow-hidden'>
				<video className='absolute inset-0 w-full h-full object-cover' autoPlay muted loop playsInline src={videoSrc} poster='/placeholder.svg?height=1080&width=1920' />
						...
						<div className='space-y-4'>
							...
							<div>
								...
								<div className='relative'>
									...
									<input
										...
										className='block w-full pl-10 pr-10 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-[#4361EE] focus:border-transparent'
										placeholder='••••••••'
									/>
							...
							<div className='flex items-center justify-between'>
								<div className='flex items-center'>
									<input id='remember-me' name='remember-me' type='checkbox' className='h-4 w-4 text-[#4361EE] focus:ring-[#4361EE] border-gray-300 rounded' />
