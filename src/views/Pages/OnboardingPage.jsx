...
const steps = [
	{
		...
		description: "You now have access to armincx for the next 14 days. First, let's customize your setup by answering a few quick questions.",
	...
	},
	{
		...
		description: "An inbox is a centralized space for your team to access messages coming from multiple channels (e.g. email, SMS, Facebook)",
										...
										{step.options.map((option) => (
											<div
												...
												className={`relative rounded-lg border ${
													selections.team === option.id ? "border-[#4361EE] bg-[#4361EE]/5" : "border-gray-200 hover:border-gray-300"
										...
										<div className='grid grid-cols-2 gap-3 mb-8'>
											{step.options.map((option) => (
												<div
													key={option.id}
													className={`relative rounded-lg border ${
														selections.channels.includes(option.id) ? "border-[#4361EE] bg-[#4361EE]/5" : "border-gray-200 hover:border-gray-300"
													} p-4 cursor-pointer transition-colors`}
										...
										<div className='flex gap-4 mb-6'>
											{step.secondaryOptions.map((option) => (
												<div
													key={option.id}
													className={`relative rounded-lg border ${
														selections.usingTool === option.id ? "border-[#4361EE] bg-[#4361EE]/5" : "border-gray-200 hover:border-gray-300"
													} p-4 cursor-pointer transition-colors`}
									...
									<div className='text-center'>
										<div className='w-48 h-48 mx-auto mb-6 bg-white rounded-full shadow-md flex items-center justify-center'>
											<svg width='120' height='120' viewBox='0 0 120 120' fill='none' xmlns='http://www.w3.org/2000/svg'>
												...
												<path d='M60 65C71.0457 65 80 73.9543 80 85V100H40V85C40 73.9543 48.9543 65 60 65Z' fill='#4361EE' />
												<path d='M30 90C36.6274 90 42 95.3726 42 102V110H18V102C18 95.3726 23.3726 90 30 90Z' fill='#1FB7DD' />
												<path d='M90 90C96.6274 90 102 95.3726 102 102V110H78V102C78 95.3726 83.3726 90 90 90Z' fill='#9D4EDD' />
											</svg>
										</div>
													...
													<div className='bg-gray-50 rounded-lg p-3 mb-3'>
														<div className='flex items-start'>
															...
															<div className='ml-3'>
																...
																<div className='text-sm text-gray-700'>Hi team, I'm having an issue with the latest update. Can you help?</div>
															</div>
														</div>
													</div>
